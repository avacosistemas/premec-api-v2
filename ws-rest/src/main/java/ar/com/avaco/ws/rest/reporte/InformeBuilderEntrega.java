...
//			addRepuestos(document);
	...
	private void addActividad(Document document) throws DocumentException {
		...
		table.addCell(cell);
		cell.setPhrase(new Phrase(DateUtils.toString(DateUtils.toDate(dto.getFecha(), "yyyy-MM-dd"), "dd/MM/yyyy") , fontText));
		table.addCell(cell);
...
//		addHeader("REPUESTOS", document);
	...
	private void addOperarios(Document document) throws DocumentException {
		...
		cell.setPhrase(new Phrase(DateUtils.toString(DateUtils.toDate(dto.getFechaInicioOperario(), "yyyy-MM-dd"), "dd/MM/yyyy") , fontText));
		table.addCell(cell);
		cell.setPhrase(new Phrase(dto.getHoraInicioOperario(), fontText));
		table.addCell(cell);
		cell.setPhrase(new Phrase(DateUtils.toString(DateUtils.toDate(dto.getFechaFinoOperario(), "yyyy-MM-dd"), "dd/MM/yyyy") , fontText));
		table.addCell(cell);
